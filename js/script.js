...
$(document).ready(function ($) {
    ...
    /*	Contact Map 2
	/* ---------------------------------------------------------------------- */
    var contact = { "lat": "40.7632192", "lon": "-96.7000615" }; //Change a map coordinate here!
...
/* ---------------------------------------------------------------------- */
function initialize() {
    var bryantPark = new google.maps.LatLng(40.7632192, -96.7000615); //Change a map street view cordinate here! {"lat":"-33.880641", "lon":"151.204298"}
    var panoramaOptions = {
        position: bryantPark,
        pov: {
            heading: 165,
